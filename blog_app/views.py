...
#         serilizer = BlogSerialiizer(queryset,many=True)
#         return Response(serilizer.data)
#     def retrieve(self,request,pk=None):
#         queryset = Blog.objects.filter(is_public=True)
#         blog_list = get_object_or_404(queryset,pk=pk)
#         serializer = BlogSerialiizer(blog_list)
#         return Response(serializer.data)
#     def create(self,request):
#         serializer = BlogSerialiizer(data = request.data)
...
#         serializer = BlogSerialiizer(blog,data=request.data)
#         if serializer.is_valid():
#             serializer.save()
#             return Response(serializer.data)
#         return Response(serializer.errors,status=status.HTTP_400_BAD_REQUEST)
